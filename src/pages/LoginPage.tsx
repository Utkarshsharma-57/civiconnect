...
import { loginUser, validateEmail } from '../utils/authUtils';
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer group">
                  <input
                    ...
                    disabled={loading}
                  />
                  <span className="ml-3 text-sm text-neutral-600 group-hover:text-neutral-800 transition-colors duration-200">
                    Remember me
                  </span>
                </label>
                <Link
